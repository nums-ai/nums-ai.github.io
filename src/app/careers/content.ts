...
export const careersContent = {
  ...
  about: {
    title: "About Nums AI",
    paragraphs: [
      "주식회사 넘즈에이아이는 표와 숫자를 위한 정형 데이터 파운데이션 모델(TFM)을 만드는 AI 스타트업입니다. 세계적인 AI 연구를 선도할 수 있는 전문성을 갖추고 있는 팀입니다. 수치 예측을 위한 글로벌 프론티어 모델을 직접 개발합니다.",
  ...
  roles: [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "고객 문제를 구체적인 PoC 형태로 전환하고 데이터 준비, 기술 검증, 결과 발표까지 전 과정을 설계합니다.",
